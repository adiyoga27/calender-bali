...
class SakaCalendar{
	...
	function checkPurnama()
	{
		$this->tilem = false;
		$this->purnama =  false;
		if($this->isPangelong == true && $this->penanggal == '15'){
 			return $this->tilem = true;
		}

		if($this->isPangelong == false && $this->penanggal == '15'){
			return $this->purnama = true;
		}
	}

	function checkHariBaik($uripTriwara)
	{
		if($uripTriwara == 1){
			 $this->hariBaik =  "boleh";
		}else{
			 $this->hariBaik =  "tidak boleh";
